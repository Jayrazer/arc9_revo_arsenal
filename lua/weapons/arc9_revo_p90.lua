...
SWEP.PrintName = "P90"
SWEP.Description = "Compact, high-capacity and able to shred armor, the P90's distinctive shape and high-tech feature set have made it the quintessential sci-fi gun. The weapon was the first of many developed in response to a request by NATO to create a compact weapon with more stopping power than a traditional submachine gun to equip troops that would see combat less frequently, such as tank crews. \n\nOriginally from Sharksenal."

SWEP.Class = "Personal Defense Weapon" -- In the Customization Menu
...
SWEP.Credits = {
	["Model & textures"] = "Battlestate Games",
	["Animations"] = "speedonerd",
	["Sounds"] = "Navarro, Tripwire Interactive",
	["Lua"] = "speedonerd"
}
...
---- View & Worldmodel
SWEP.ViewModel = "models/weapons/cw2_sharksenal/v_p90.mdl"
SWEP.WorldModel = "models/weapons/cw2_sharksenal/w_p90.mdl"
...
---- Sounds
local pathP90 = "weapons/cw2_shark/p90/"
local pathSTGW = "mgmp/stgw57/"

SWEP.ShootSound = {
	"^" .. pathP90 .. "mp5_fire.wav",
	"^" .. pathP90 .. "mp5_fire2.wav",
}

SWEP.ShootSoundSilenced = {

	pathP90 .. "firesil1.wav",
	pathP90 .. "firesil2.wav",
	pathP90 .. "firesil3.wav"
...
SWEP.Animations = {
	...
	["fire"] = {
        ...
        EventTable = {
			{ s = pathP90 .. "mp5_boltback.wav", t = 0.02, v = 0.2 },
		}
    },
	["fire_sights"] = {
        Source = "fire_aim",
	...
	["reload"] = {
		...
		EventTable = {
			...
			{ s = pathP90 .. "mp5_magrelease.wav", t = 0.5, v = 0.6 },
			{ s = pathP90 .. "smg_clip_out_1.wav", t = 0.6, v = 0.6 },
			{ s = pathSTGW .. "magfetch.wav", t = 0.9, v = 0.6 },
			{ s = pathP90 .. "mp5_magin.wav", t = 2.2, v = 0.6 },
			{ s = pathP90 .. "smg_clip_locked_1.wav", t = 2.4, v = 0.6 },
		}
	},
	["reload_empty"] = {
		Source = "reload_empty",
		...
		EventTable = {
			...
			{ s = pathP90 .. "mp5_magin.wav", t = 2.2, v = 0.6 },
			{ s = pathP90 .. "smg_clip_locked_1.wav", t = 2.4, v = 0.6 },
			{ s = pathP90 .. "mp5_boltback.wav", t = 2.95, v = 0.6 },
			{ s = pathP90 .. "smg_slideforward_1.wav", t = 3.1, v = 0.6 },
		}
	},
}
