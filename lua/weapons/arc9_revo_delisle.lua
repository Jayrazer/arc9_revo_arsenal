...
---- View & Worldmodel
SWEP.ViewModel = "models/weapons/khrcw2/delisle.mdl"
SWEP.WorldModel = "models/weapons/khrcw2/w_delisle.mdl"
...
---- Sounds
local pathDeLisle = "khrcw2/delisle/"

SWEP.ShootSound = "^" .. pathDeLisle .. "aac-1.wav"

SWEP.ShootSoundSilenced = pathDeLisle .. "aac-1.wav"
...
SWEP.Animations = {
	...
	["fire"] = {
        Source = "fire",
        EventTable = {
			{ s = pathDeLisle .. "bolt1.wav", t = 0.05, v = 0.7 },
			{ s = pathDeLisle .. "bolt2.wav", t = 0.3, v = 0.7 },
		}
    },
	["fire_sights"] = {
        Source = "fireiron",
	...
	["reload"] = {
		...
		FireASAP = true,
		EventTable = {
			{ s = pathDeLisle .. "magrelease.wav", t = 0.1, v = 0.6 },
			{ s = pathDeLisle .. "magout.wav", t = 0.3, v = 0.6 },
			{ s = pathDeLisle .. "magrelease.wav", t = 1, v = 0.6 },
			{ s = pathDeLisle .. "magin.wav", t = 1.1, v = 0.6 },
	...
	["reload_empty"] = {
		...
		EventTable = {
			...
			{ s = pathDeLisle .. "magrelease.wav", t = 1, v = 0.6 },
			{ s = pathDeLisle .. "magin.wav", t = 1.1, v = 0.6 },
			{ s = pathDeLisle .. "bolt1.wav", t = 1.75, v = 0.6 },
			{ s = pathDeLisle .. "bolt2.wav", t = 2.05, v = 0.6 },
		}
	}
}
